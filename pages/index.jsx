    ...
    <div>
      ...
      >
        ...
        <h2 className="max-w-3xl text-center text-lg sm:text-xl">
          For musicians, practicing is important, but can be boring.
          Practice Music makes practicing more rewarding, with a practice
          music buddy, music journal log, rainbow colors and a competitive leaderboard!
        </h2>
        <div className="mt-4">
